import svgPaths from "./svg-a22gsomrit";
...
function Component() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[20px] h-[77px] items-center justify-center left-1/2 not-italic text-[#f8fafb] text-center top-[calc(50%-0.5px)]" data-name="헤더이미지텍스트">
      <p className="font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] relative shrink-0 text-[32px] w-[400px]">PEOPLE</p>
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] relative shrink-0 text-[14px] whitespace-nowrap">사람중심 철학과</p>
    </div>
  );
}
...
function Component2() {
  return (
    <div className="content-stretch flex items-center leading-[20px] relative shrink-0" data-name="페이지">
      <p className="font-['Pretendard:ExtraBold',sans-serif] relative shrink-0">{`01 / `}</p>
      <p className="font-['Pretendard:Regular',sans-serif] relative shrink-0">04</p>
    </div>
  );
}
...
function Component1() {
  return (
    <div className="-translate-x-1/2 absolute bottom-[11px] content-stretch flex gap-[18px] items-end justify-center left-[calc(50%+1.5px)] not-italic text-[#d9d9d9] text-[14px] text-center whitespace-nowrap" data-name="메인이미지방향키">
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] relative shrink-0">〈</p>
      <Component2 />
      <button className="block cursor-pointer font-['Pretendard:Regular',sans-serif] leading-[0] relative shrink-0">
...
function Component3() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-0 px-[8px] top-0 w-[402px]" data-name="헤더메뉴">
      <p className="flex-[1_0_0] font-['Jalnan_2:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#f8fafb] text-[32px]">saramin</p>
      <Component4 />
    </div>
  );
}
...
function Header() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Header">
      <div className="h-[580px] relative shrink-0 w-[402px]" data-name="헤더이미지">
...
function Component6() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:SemiBold',sans-serif] items-start leading-[normal] not-italic relative shrink-0 text-[#222] text-[24px] w-full" data-name="섹션1/텍스트">
...
function Component7() {
  return (
    <div className="h-[228px] overflow-clip relative rounded-[16px] shrink-0 w-full" data-name="서비스내용영상">
      ...
      <div className="absolute content-stretch flex gap-[2px] h-[6px] items-center left-[12px] top-[202px] w-[85px]" data-name="영상하단바:타임">
        <div className="bg-[#f8fafb] h-[4px] shrink-0 w-[85px]" data-name="영상하단바:호버" />
        <div className="bg-[#f8fafb] h-[4px] opacity-50 shrink-0 w-[85px]" data-name="영상하단바:호버" />
        <div className="bg-[#f8fafb] h-[4px] opacity-50 shrink-0 w-[85px]" data-name="영상하단바:호버" />
        <div className="bg-[#f8fafb] h-[4px] opacity-50 shrink-0 w-[85px]" data-name="영상하단바:호버" />
      </div>
    </div>
...
function Component9() {
  return (
    <div className="content-stretch flex flex-col gap-[11px] items-start not-italic relative shrink-0 text-[#222] w-full" data-name="영상텍스트내용">
      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[normal] relative shrink-0 text-[24px] w-full">사람인</p>
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] relative shrink-0 text-[14px] w-full">대한민국 국민이라면 누구에게나 친숙한 커리어 플랫폼. 구인, 구직을 넘어, 일하는 모든 날 모든 순간이 즐거울 수 있도록 노력하는 사람인의 주요 서비스들을 확인해보세요.</p>
    </div>
  );
}
...
function Component8() {
  return (
    <div className="relative shrink-0 w-full" data-name="영상내용">
      <div className="content-stretch flex flex-col gap-[18px] items-start px-[12px] py-[4px] relative w-full">
        <Component9 />
        <div className="content-stretch flex items-center justify-center px-[20px] py-[8px] relative rounded-[28px] shrink-0" data-name="버튼">
          <div aria-hidden="true" className="absolute border-[#222] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[28px]" />
          <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222] text-[14px] whitespace-nowrap">자세히 보기</p>
        </div>
      </div>
    </div>
  );
...
function Component5() {
  return (
    <div className="relative shrink-0 w-full" data-name="섹션1">
      <div className="content-stretch flex flex-col gap-[32px] items-start px-[16px] py-[40px] relative w-full">
        <Component6 />
        <div className="content-stretch flex flex-col gap-[32px] h-[438px] items-start py-[12px] relative shrink-0 w-full" data-name="서비스내용:모바일">
          <Component7 />
          <Component8 />
        </div>
      </div>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:SemiBold',sans-serif] items-start leading-[normal] relative shrink-0 text-[24px] w-full">
...
function Component11() {
  return (
    <div className="content-stretch flex flex-col gap-[28px] items-start not-italic relative shrink-0 text-[#222] w-full" data-name="섹션2/텍스트">
      <Frame />
...
function Component12() {
  return (
    <div className="bg-[#d9d9d9] overflow-clip relative shrink-0 size-[100px]" data-name="컨텐츠카드 이미지">
      <div className="absolute h-[101px] left-0 top-0 w-[100px]" data-name="imgi_4_culture01 1">
...
function Component14() {
  return (
    <div className="content-stretch flex flex-col items-center leading-[normal] relative shrink-0 text-center w-[83px]" data-name="카드제목">
      <p className="font-['Pretendard:SemiBold',sans-serif] relative shrink-0 text-[24px] w-full">Work</p>
      <p className="font-['Pretendard:Medium',sans-serif] relative shrink-0 text-[18px] w-full">일하는 방식</p>
    </div>
  );
}
...
function Component13() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[118px] items-center not-italic relative shrink-0 text-[#222] w-full" data-name="카드내용">
      <Component14 />
...
function Component15() {
  return (
    <div className="bg-[#d9d9d9] overflow-clip relative shrink-0 size-[100px]" data-name="컨텐츠카드 이미지">
      <div className="absolute h-[100px] left-[-5px] top-0 w-[104px]" data-name="imgi_5_culture02 1">
...
function Component17() {
  return (
    <div className="content-stretch flex flex-col items-center leading-[normal] relative shrink-0 text-center w-[83px]" data-name="카드제목">
      <p className="font-['Pretendard:SemiBold',sans-serif] relative shrink-0 text-[24px] w-full">Welfare</p>
      <p className="font-['Pretendard:Medium',sans-serif] relative shrink-0 text-[18px] w-full">사내복지</p>
    </div>
  );
}
...
function Component18() {
  return (
    <div className="bg-[#d9d9d9] overflow-clip relative shrink-0 size-[100px]" data-name="컨텐츠카드 이미지">
      <div className="absolute h-[100px] left-[-15px] top-0 w-[130px]" data-name="imgi_6_culture03 1">
...
function Component20() {
  return (
    <div className="content-stretch flex flex-col items-center leading-[normal] relative shrink-0 text-center w-[83px]" data-name="카드제목">
      <p className="font-['Pretendard:SemiBold',sans-serif] relative shrink-0 text-[24px] w-full">Education</p>
      <p className="font-['Pretendard:Medium',sans-serif] relative shrink-0 text-[18px] w-full">인재육성</p>
    </div>
  );
}
...
function Component10() {
  return (
    <div className="relative shrink-0 w-full" data-name="섹션2">
      <div className="content-stretch flex flex-col gap-[20px] items-start px-[16px] py-[40px] relative w-full">
        <Component11 />
        <div className="content-stretch flex gap-[31px] h-[321px] items-center overflow-clip px-[8px] relative shrink-0 w-[370px]" data-name="컨텐츠케러셀">
          <div className="bg-[#f8fafb] content-stretch flex flex-col gap-[16px] h-[297px] items-center overflow-clip px-[16px] py-[32px] relative rounded-[16px] shadow-[0px_0px_8px_2px_rgba(0,0,0,0.25)] shrink-0 w-[270px]" data-name="컨텐츠카드">
            <Component12 />
            <Component13 />
          </div>
          <div className="bg-[#f8fafb] content-stretch flex flex-col gap-[16px] h-[297px] items-center overflow-clip px-[16px] py-[32px] relative rounded-[16px] shadow-[0px_0px_8px_2px_rgba(0,0,0,0.25)] shrink-0 w-[270px]" data-name="컨텐츠카드">
          ...
          <button className="absolute content-stretch cursor-pointer flex flex-col h-[200px] items-center justify-center left-[345px] p-[8px] top-[23px] w-[33px]" data-name="이동버튼">
            <p className="font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#d9d9d9] text-[32px] text-left w-full">〉</p>
          </button>
        </div>
      </div>
    </div>
...
function Component22() {
  return (
    <div className="content-stretch flex items-center justify-center py-[32px] relative shrink-0 w-full" data-name="사내이벤트제목">
      <p className="flex-[1_0_0] font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#222] text-[32px] text-center">INSIDE STORY</p>
    </div>
  );
}
...
function Component23() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center relative shrink-0 w-[370px]" data-name="사내이벤트">
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="사내이벤트1:호버">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="사내이벤트2:호버">
        <div className="content-stretch flex flex-col gap-[31px] h-[351px] items-start overflow-clip relative shrink-0 w-[370px]" data-name="사내이벤트">
          <Component26 />
          <Component27 />
        </div>
      </div>
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="사내이벤트3:호버">
        <div className="content-stretch flex flex-col gap-[31px] h-[351px] items-start overflow-clip relative shrink-0 w-[370px]" data-name="사내이벤트">
          <Component28 />
          <Component29 />
        </div>
      </div>
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="사내이벤트4:호버">
        <div className="content-stretch flex flex-col gap-[31px] h-[351px] items-start overflow-clip relative shrink-0 w-[370px]" data-name="사내이벤트">
          <Component30 />
          <Component31 />
        </div>
      </div>
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="사내이벤트5:호버">
        <div className="content-stretch flex flex-col gap-[31px] h-[351px] items-start overflow-clip relative shrink-0 w-[370px]" data-name="사내이벤트">
          <Component32 />
          <Component33 />
        </div>
      </div>
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="사내이벤트6:호버">
        <div className="content-stretch flex flex-col gap-[31px] h-[351px] items-start overflow-clip relative shrink-0 w-[370px]" data-name="사내이벤트">
          <Component34 />
          <Component35 />
        </div>
...
function Component36() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0 w-[380px]" data-name="섹션3-뉴스">
      <p className="font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222] text-[32px] text-center w-full">NEWS</p>
      <div className="content-stretch flex gap-[20px] items-center overflow-clip relative shrink-0 w-full" data-name="뉴스">
        <div className="h-[206px] relative shrink-0 w-[338px]" data-name="뉴스">
          <p className="absolute font-['Pretendard:Medium',sans-serif] inset-[26.21%_0_53.4%_0] leading-[normal] not-italic text-[#464646] text-[18px]">사람인, ‘커리어 매칭 에이전트’ 전격 출시…취업 준비 방법 혁신</p>
          <div className="absolute bg-[#464646] inset-[70.87%_0_27.18%_0]" />
          <p className="absolute font-['Pretendard:Regular',sans-serif] inset-[90.29%_76.63%_0_0] leading-[20px] not-italic text-[#464646] text-[14px] whitespace-nowrap">2026-03-26</p>
          <div className="absolute content-stretch flex inset-[1.94%_83.14%_84.47%_-2.37%] items-center justify-center px-[8px] py-[4px]" data-name="뉴스종류">
            <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#464646] text-[14px] whitespace-nowrap">취업뉴스</p>
          </div>
        </div>
        <div className="h-[206px] relative shrink-0 w-[338px]" data-name="뉴스">
          <p className="absolute font-['Pretendard:Medium',sans-serif] inset-[26.21%_0_53.4%_0] leading-[normal] not-italic text-[#464646] text-[18px]">{`사람인, 'ChatGPT for kakao' 파트너사 합류, HR AI 에이전트 광폭 행보`}</p>
          <div className="absolute bg-[#464646] inset-[70.87%_0_27.18%_0]" />
          <p className="absolute font-['Pretendard:Regular',sans-serif] inset-[90.29%_76.63%_0_0] leading-[20px] not-italic text-[#464646] text-[14px] whitespace-nowrap">2026-03-25</p>
          <div className="absolute content-stretch flex inset-[1.94%_83.14%_84.47%_-2.37%] items-center justify-center px-[8px] py-[4px]" data-name="뉴스종류">
            <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222] text-[14px] whitespace-nowrap">회사소식</p>
          </div>
        </div>
        <div className="h-[206px] relative shrink-0 w-[338px]" data-name="뉴스">
          <p className="absolute font-['Pretendard:Medium',sans-serif] inset-[26.21%_0_53.4%_0] leading-[normal] not-italic text-[#464646] text-[18px]">{`'내 손안의 AI 취업 에이전트'...사람인, 신입,인턴 전용 홈 전면 개편`}</p>
          <div className="absolute bg-[#464646] inset-[70.87%_0_27.18%_0]" />
          <p className="absolute font-['Pretendard:Regular',sans-serif] inset-[90.29%_76.63%_0_0] leading-[20px] not-italic text-[#464646] text-[14px] whitespace-nowrap">2026-03-04</p>
          <div className="absolute content-stretch flex inset-[1.94%_83.14%_84.47%_-2.37%] items-center justify-center px-[8px] py-[4px]" data-name="뉴스종류">
            <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#464646] text-[14px] whitespace-nowrap">취업뉴스</p>
          </div>
        </div>
        <div className="h-[206px] relative shrink-0 w-[338px]" data-name="뉴스">
          <p className="absolute font-['Pretendard:Medium',sans-serif] inset-[26.21%_0_53.4%_0] leading-[normal] not-italic text-[#464646] text-[18px]">사람인, 지난해 입사지원 5500만 돌파, 국민 커리어 플랫폼 인증</p>
          <div className="absolute bg-[#464646] inset-[70.87%_0_27.18%_0]" />
          <p className="absolute font-['Pretendard:Regular',sans-serif] inset-[90.29%_76.63%_0_0] leading-[20px] not-italic text-[#464646] text-[14px] whitespace-nowrap">2026-01-20</p>
          <div className="absolute content-stretch flex inset-[1.94%_83.14%_84.47%_-2.37%] items-center justify-center px-[8px] py-[4px]" data-name="뉴스종류">
            <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222] text-[14px] whitespace-nowrap">회사소식</p>
          </div>
        </div>
        <button className="absolute content-stretch cursor-pointer flex flex-col h-[206px] items-end justify-center p-[8px] right-0 top-0 w-[33px]" data-name="이동버튼">
          <p className="font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#d9d9d9] text-[32px] text-left w-full">〉</p>
        </button>
      </div>
    </div>
...
function Component21() {
  return (
    <div className="bg-[#e6f9f5] content-stretch flex flex-col gap-[20px] items-center px-[16px] py-[40px] relative shrink-0 w-[402px]" data-name="섹션3">
      <Component22 />
      <Component23 />
      <Component36 />
    </div>
...
function MaterialSymbolsBarChart() {
  return (
    <div className="mb-[-4px] relative shrink-0 size-[24px]" data-name="material-symbols:bar-chart">
...
function Component40() {
  return (
    <div className="content-stretch flex gap-[8px] items-center mb-[-4px] not-italic relative shrink-0 w-full whitespace-nowrap" data-name="투자정보">
      <p className="font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] relative shrink-0 text-[#222] text-[32px]">투자정보</p>
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] relative shrink-0 text-[#aaa] text-[14px]">사람인 143240</p>
    </div>
  );
}
...
function Component39() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[4px] relative shrink-0 w-full" data-name="투자정보상단">
...
function Component41() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="투자정보2">
      ...
      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222] text-[24px] whitespace-nowrap">16,970</p>
...
function Component38() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full" data-name="투자정보">
      <Component39 />
      <Component41 />
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#aaa] text-[14px] whitespace-nowrap">2026-03-30 10:56:31</p>
    </div>
  );
}
...
function Component37() {
  return (
    <div className="relative shrink-0 w-full" data-name="섹션4">
      <div className="content-stretch flex flex-col gap-[18px] items-start pb-[120px] pl-[20px] pr-[16px] pt-[40px] relative w-full">
        <Component38 />
        <div className="content-stretch flex items-center justify-center px-[20px] py-[8px] relative rounded-[28px] shrink-0" data-name="버튼">
          <div aria-hidden="true" className="absolute border-[#d9d9d9] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[28px]" />
          <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222] text-[14px] whitespace-nowrap">투자정보 보기 〉</p>
        </div>
      </div>
    </div>
  );
...
function Component44() {
  return (
    <div className="content-stretch flex gap-[20px] items-start justify-center leading-[20px] not-italic relative shrink-0 text-[14px] text-white w-full whitespace-nowrap" data-name="푸터1">
...
function Component45() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:Regular',sans-serif] gap-[8px] items-start leading-[20px] not-italic relative shrink-0 text-[14px] text-white w-full" data-name="푸터2">
...
function Component47() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:Regular',sans-serif] gap-[8px] items-start leading-[20px] not-italic relative shrink-0 text-[14px] text-white w-full" data-name="푸터4">
...
function Component43() {
  return (
    <div className="relative shrink-0 w-full" data-name="푸터텍스트">
      <div className="content-stretch flex flex-col gap-[25px] items-start pb-[20px] pl-[16px] pt-[100px] relative w-full">
        <Component44 />
        <Component45 />
        <Component46 />
        <Component47 />
        <Component48 />
        <p className="font-['Pretendard:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[24px] text-white w-full">사람과 일을 잇는 행복 Bridge</p>
      </div>
    </div>
  );
}
...
function Component42() {
  return (
    <div className="bg-[#00967b] content-stretch flex flex-col items-start relative shrink-0 w-[402px]" data-name="푸터">
      <Component43 />
