import svgPaths from "./svg-ru4uxo5hoi";
...
function Component() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[20px] h-[77px] items-center justify-center left-1/2 not-italic text-[#f8fafb] text-center top-[calc(50%-0.5px)]" data-name="헤더이미지텍스트">
      <p className="font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] relative shrink-0 text-[100px] w-[400px]">PEOPLE</p>
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] relative shrink-0 text-[22px] whitespace-nowrap">사람중심 철학과</p>
    </div>
  );
}
...
function Component2() {
  return (
    <div className="content-stretch flex items-center leading-[20px] relative shrink-0" data-name="페이지">
      ...
      <p className="font-['Pretendard:Regular',sans-serif] relative shrink-0 text-[22px]">04</p>
    </div>
  );
}
...
function Component1() {
  return (
    <div className="-translate-x-1/2 absolute bottom-[11px] content-stretch flex gap-[18px] items-end justify-center left-[calc(50%+1.5px)] not-italic text-[#d9d9d9] text-center whitespace-nowrap" data-name="메인이미지방향키">
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] relative shrink-0 text-[22px]">〈</p>
      <Component2 />
      <button className="block cursor-pointer font-['Pretendard:Regular',sans-serif] leading-[0] relative shrink-0 text-[22px]">
...
function Component3() {
  return (
    <div className="absolute content-stretch flex items-end justify-between left-0 px-[8px] top-0 w-[1280px]" data-name="헤더메뉴">
...
function Header() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Header">
      <div className="h-[900px] relative shrink-0 w-[1280px]" data-name="헤더이미지">
...
function Component6() {
  return (
    <div className="relative shrink-0 w-full" data-name="섹션1/텍스트">
      <div className="content-stretch flex flex-col font-['Pretendard:SemiBold',sans-serif] items-start leading-[normal] not-italic px-[128px] relative text-[#222] text-[60px] w-full">
...
function Component9() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="텍스트">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[28px] items-center justify-center leading-[normal] not-italic px-[40px] relative size-full text-[#f8fafb]">
          <p className="font-['Pretendard:SemiBold',sans-serif] relative shrink-0 text-[60px] w-full">사람인</p>
          <p className="font-['Pretendard:Medium',sans-serif] relative shrink-0 text-[28px] w-full">대한민국 국민이라면 누구에게나 친숙한 커리어 플랫폼. 구인, 구직을 넘어, 일하는 모든 날 모든 순간이 즐거울 수 있도록 노력하는 사람인의 주요 서비스들을 확인해보세요.</p>
        </div>
      </div>
    </div>
  );
...
function Component8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[28px] h-[896px] items-start justify-end left-0 overflow-clip px-[24px] py-[33px] top-0 w-[1020px]" data-name="오버레이">
      <Component9 />
      <div className="content-stretch flex items-end px-[20px] py-[8px] relative rounded-[28px] shrink-0" data-name="버튼">
        ...
        <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#f8fafb] text-[22px] whitespace-nowrap">자세히 보기</p>
      </div>
      <div className="content-stretch flex gap-[2px] h-[10px] items-end relative shrink-0 w-[240px]" data-name="영상하단바:타임">
        <div className="bg-[#f8fafb] h-[8px] shrink-0 w-[240px]" data-name="영상하단바:호버" />
        <button className="bg-[#f8fafb] block cursor-pointer h-[8px] opacity-50 relative shrink-0 w-[240px]" data-name="영상하단바:호버" />
        <button className="bg-[#f8fafb] block cursor-pointer h-[8px] opacity-50 relative shrink-0 w-[240px]" data-name="영상하단바:호버" />
        <button className="bg-[#f8fafb] block cursor-pointer h-[8px] opacity-50 relative shrink-0 w-[240px]" data-name="영상하단바:호버" />
      </div>
    </div>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:SemiBold',sans-serif] items-start leading-[normal] relative shrink-0 text-[60px] w-full">
...
function Component10() {
  return (
    <div className="relative shrink-0 w-full" data-name="섹션2/텍스트">
      <div className="content-stretch flex flex-col gap-[28px] items-start not-italic px-[128px] relative text-[#222] w-full">
        <Frame />
...
function Component13() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] h-[76px] items-center not-italic relative shrink-0 text-[#222] w-full" data-name="카드내용">
      <Component14 />
      <p className="font-['Pretendard:Regular',sans-serif] h-[60px] leading-[20px] min-w-full relative shrink-0 text-[16px] w-[min-content]">직원 경험을 기반으로 만들어가는 1등이 될 수 밖에 없었던 구성원들의 일하는 방식입니다.</p>
    </div>
  );
}
...
function Component16() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] h-[76px] items-center not-italic relative shrink-0 text-[#222] w-full" data-name="카드내용">
      <Component17 />
      <p className="font-['Pretendard:Regular',sans-serif] h-[60px] leading-[20px] min-w-full relative shrink-0 text-[16px] w-[min-content]">건강, 휴가, 나아가 가족의 일까지 챙겨 마음 편히 행복하게 일할 수 있는 사람인입니다.</p>
    </div>
  );
}
...
function Component19() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] h-[76px] items-center not-italic relative shrink-0 text-[#222] w-full" data-name="카드내용">
      <Component20 />
      <p className="font-['Pretendard:Regular',sans-serif] h-[60px] leading-[20px] min-w-full relative shrink-0 text-[16px] w-[min-content]">사람인은 직원들이 자신의 역량을 꾸준히 개발할 수 있도록 지원을 아끼지 않습니다.</p>
    </div>
  );
}
...
function Component11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[32px] items-center justify-center min-h-px min-w-px relative w-full" data-name="섹션2-컨텐츠카드">
      <div className="bg-[#f8fafb] content-stretch flex flex-col gap-[60px] h-[500px] items-center overflow-clip px-[16px] py-[32px] relative rounded-[16px] shadow-[0px_0px_8px_2px_rgba(0,0,0,0.25)] shrink-0 w-[324px]" data-name="컨텐츠카드:태블릿,데탑">
        <Component12 />
        <Component13 />
      </div>
      <div className="bg-[#f8fafb] content-stretch flex flex-col gap-[60px] h-[500px] items-center overflow-clip px-[16px] py-[32px] relative rounded-[16px] shadow-[0px_0px_8px_2px_rgba(0,0,0,0.25)] shrink-0 w-[324px]" data-name="컨텐츠카드:태블릿,데탑">
...
function Component7() {
  return (
    <div className="h-[1788px] relative shrink-0 w-full" data-name="섹션2">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[60px] items-center justify-center px-[16px] py-[40px] relative size-full">
          <div className="h-[896px] overflow-clip relative shrink-0 w-[1020px]" data-name="서비스내용영상">
...
function Component22() {
  return (
    <div className="content-stretch flex items-center justify-center py-[32px] relative shrink-0 w-full" data-name="사내이벤트제목">
      <p className="flex-[1_0_0] font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[#222] text-[100px] text-center">INSIDE STORY</p>
    </div>
  );
}
...
function Component23() {
  return (
    <div className="gap-x-[8px] gap-y-[20px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[repeat(2,fit-content(100%))] relative shrink-0 w-[1144px]" data-name="사내이벤트">
      ...
      <div className="col-3 justify-self-stretch relative row-1 self-start shrink-0" data-name="사내이벤트3:호버">
        <div className="content-stretch flex flex-col items-start px-[4px] relative w-full">
          <div className="content-stretch flex flex-col gap-[31px] h-[351px] items-start overflow-clip relative shrink-0 w-[370px]" data-name="사내이벤트">
            <Component28 />
            <Component29 />
      ...
      <div className="col-1 justify-self-stretch relative row-2 self-start shrink-0" data-name="사내이벤트4:호버">
      ...
      <div className="col-2 justify-self-stretch relative row-2 self-start shrink-0" data-name="사내이벤트5:호버">
        <div className="content-stretch flex flex-col items-start px-[4px] relative w-full">
          <div className="content-stretch flex flex-col gap-[31px] h-[351px] items-start overflow-clip relative shrink-0 w-[370px]" data-name="사내이벤트">
            <Component32 />
            <Component33 />
      ...
      <div className="col-3 justify-self-stretch relative row-2 self-start shrink-0" data-name="사내이벤트6:호버">
        <div className="content-stretch flex flex-col items-start px-[4px] relative w-full">
          <div className="content-stretch flex flex-col gap-[31px] h-[351px] items-start overflow-clip relative shrink-0 w-[370px]" data-name="사내이벤트">
            <Component34 />
            <Component35 />
...
function Component36() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="섹션3-뉴스">
      <p className="font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222] text-[100px] text-center w-full">NEWS</p>
    </div>
  );
}
...
function Component37() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="뉴스">
      <div className="content-stretch flex flex-col gap-[37px] h-[203px] items-start relative shrink-0 w-[263px]" data-name="뉴스1">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[4px] relative shrink-0" data-name="뉴스종류">
          <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222] text-[22px] whitespace-nowrap">취업뉴스</p>
        </div>
        <p className="font-['Pretendard:Regular',sans-serif] h-[40px] leading-[normal] not-italic relative shrink-0 text-[#222] text-[20px] w-[263px]">사람인, ‘커리어 매칭 에이전트’ 전격 출시... 취업 준비 방법 혁신</p>
        <div className="bg-[#222] h-[4px] shrink-0 w-[260px]" />
        <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] min-w-full not-italic relative shrink-0 text-[#d9d9d9] text-[14px] w-[min-content]">2026-03-04</p>
      </div>
      <div className="content-stretch flex flex-col gap-[37px] h-[203px] items-start relative shrink-0 w-[263px]" data-name="뉴스2">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[4px] relative shrink-0" data-name="뉴스종류">
          <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222] text-[22px] whitespace-nowrap">회사소식</p>
        </div>
        <p className="font-['Pretendard:Regular',sans-serif] h-[40px] leading-[normal] not-italic relative shrink-0 text-[#222] text-[20px] w-[263px]">사람인, ‘ChatGPT for kakao’ 파트너사 합류, HR AI 에이전트 광폭 행보</p>
        <div className="bg-[#222] h-[4px] shrink-0 w-[260px]" />
        <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] min-w-full not-italic relative shrink-0 text-[#d9d9d9] text-[14px] w-[min-content]">2026-03-25</p>
      </div>
      <div className="content-stretch flex flex-col gap-[37px] h-[203px] items-start relative shrink-0 w-[263px]" data-name="뉴스3">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[4px] relative shrink-0" data-name="뉴스종류">
          <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222] text-[22px] whitespace-nowrap">취업뉴스</p>
        </div>
        <p className="font-['Pretendard:Regular',sans-serif] h-[40px] leading-[normal] not-italic relative shrink-0 text-[#222] text-[20px] w-[263px]">‘내 손안의 AI 취업 에이전트’... 사람인,신입,인턴 전용 홈 전면 개편</p>
        <div className="bg-[#222] h-[4px] shrink-0 w-[260px]" />
        <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] min-w-full not-italic relative shrink-0 text-[#d9d9d9] text-[14px] w-[min-content]">2026-03-04</p>
      </div>
      <div className="content-stretch flex flex-col gap-[37px] h-[203px] items-start relative shrink-0 w-[263px]" data-name="뉴스4">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[4px] relative shrink-0" data-name="뉴스종류">
          <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222] text-[22px] whitespace-nowrap">회사소식</p>
        </div>
        <p className="font-['Pretendard:Regular',sans-serif] h-[40px] leading-[normal] not-italic relative shrink-0 text-[#222] text-[20px] w-[263px]">사람인, 지난해 입사지원 5500만 돌파, 국민 커리어 플랫폼 인증</p>
        <div className="bg-[#222] h-[4px] shrink-0 w-[260px]" />
        <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] min-w-full not-italic relative shrink-0 text-[#d9d9d9] text-[14px] w-[min-content]">2026-03-25</p>
      </div>
    </div>
...
function Component21() {
  return (
    <div className="bg-[#e6f9f5] content-stretch flex flex-col gap-[40px] items-center px-[128px] py-[40px] relative shrink-0 w-[1280px]" data-name="섹션3">
      <Component22 />
      <Component23 />
      <Component36 />
      <Component37 />
...
function MaterialSymbolsBarChart() {
  return (
    <div className="mb-[-4px] relative shrink-0 size-[48px]" data-name="material-symbols:bar-chart">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="material-symbols:bar-chart">
          <path d={svgPaths.p235c0f40} fill="var(--fill-0, #222222)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Component41() {
  return (
    <div className="content-stretch flex gap-[8px] items-center mb-[-4px] not-italic relative shrink-0 text-center w-full whitespace-nowrap" data-name="투자정보">
      <p className="font-['SeoulAlrim:ExtraBold',sans-serif] leading-[normal] relative shrink-0 text-[#222] text-[48px]">투자정보</p>
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] relative shrink-0 text-[#aaa] text-[22px]">사람인 143240</p>
    </div>
  );
}
...
function Component40() {
  return (
    <div className="content-stretch flex flex-col h-[148px] items-start justify-center pb-[4px] relative shrink-0 w-full" data-name="투자정보상단">
...
function Component42() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-[278px]" data-name="투자정보2">
      <div className="h-[11px] relative shrink-0 w-[19px]" data-name="imgi_13_down 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImgi13Down1} />
      </div>
      <p className="font-['Pretendard:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#222] text-[28px] whitespace-nowrap">16,970</p>
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0">
      <Component42 />
      <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#aaa] text-[22px] whitespace-nowrap">2026-03-30 10:56:31</p>
    </div>
  );
}
...
function Component39() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative" data-name="투자정보">
      <Component40 />
      <Frame2 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="섹션4">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[18px] items-center pb-[120px] pt-[40px] px-[128px] relative w-full">
          <Component39 />
          <div className="content-stretch flex items-end px-[20px] py-[8px] relative rounded-[28px] shrink-0" data-name="버튼">
            <div aria-hidden="true" className="absolute border-[#aaa] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[28px]" />
            <p className="font-['Pretendard:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#222] text-[22px] whitespace-nowrap">투자정보 보기 〉</p>
          </div>
        </div>
      </div>
    </div>
...
function Component45() {
  return (
    <div className="content-stretch flex gap-[20px] items-start justify-center leading-[20px] not-italic relative shrink-0 text-white w-full whitespace-nowrap" data-name="푸터1">
      <p className="font-['Pretendard:Bold',sans-serif] relative shrink-0 text-[20px]">개인정보처리방침</p>
      <p className="font-['Pretendard:Regular',sans-serif] relative shrink-0 text-[22px]">내부정보관리규정</p>
      <p className="font-['Pretendard:Regular',sans-serif] relative shrink-0 text-[22px]">윤리경영</p>
    </div>
  );
}
...
function Component46() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:Regular',sans-serif] gap-[8px] items-start leading-[20px] not-italic relative shrink-0 text-[22px] text-white w-full" data-name="푸터2">
...
function Component48() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:Regular',sans-serif] gap-[8px] items-start leading-[20px] not-italic relative shrink-0 text-[22px] text-white w-full" data-name="푸터4">
...
function Component44() {
  return (
    <div className="relative shrink-0 w-full" data-name="푸터텍스트">
      <div className="content-stretch flex flex-col gap-[60px] items-start pb-[20px] pl-[16px] pt-[100px] relative w-full">
        <Component45 />
        <Component46 />
        <Component47 />
        <Component48 />
        <Component49 />
        <p className="font-['Pretendard:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[60px] text-white w-full">사람과 일을 잇는 행복 Bridge</p>
      </div>
    </div>
  );
}
...
function Component43() {
  return (
    <div className="bg-[#00967b] relative shrink-0 w-full" data-name="푸터">
      <div className="content-stretch flex flex-col items-start px-[128px] relative w-full">
        <Component44 />
        <div className="absolute bg-[#00c3a0] left-[135px] overflow-clip rounded-[50px] size-[100px] top-[-36px]" data-name="로고">
